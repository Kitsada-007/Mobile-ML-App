...
ไฟแดง/เหลือง/ไฟเสีย อยู่ใน `soloAnnouncementClasses` จึง **พูดเดี่ยวเสมอ** และทิ้งสัญญาณทิศทาง
ที่เห็นในจังหวะเดียวกันทิ้งไปด้วย (ไม่ใช่แค่ไม่รวมประโยค) เพราะ "ไฟแดง หยุดรถ ตรงไปได้"
ขัดกันเองไม่ว่าจะพูดรวมหรือพูดต่อกัน — กติกาเดียวกับที่ `SignalInterpreter` ใช้กับแบนเนอร์
