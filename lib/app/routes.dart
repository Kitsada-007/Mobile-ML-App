...
import 'package:trffic_ilght_app/features/image_detection/image_detection.dart';
...
abstract final class AppRoutes {
  ...
  static Route<void> imageDetection() =>
      MaterialPageRoute<void>(builder: (_) => const SingleImageScreen());
